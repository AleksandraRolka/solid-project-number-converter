...
protected:
    ...
    std::string negativeValueDecimalNumber{"-12341"};
...
TEST_F(DecimalValidatorTest, shouldNotPassValidationWhenNegativeValueDecimalNumberIsPassed)
{
    EXPECT_FALSE(sut.validate(negativeValueDecimalNumber));
}
